...
public class HistorialLectorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            List<String> todosPrestamos = port.listarPrestamosString();
            List<String> prestamosLector = new ArrayList<>();
            
            if (todosPrestamos != null) {
                for (String prestamo : todosPrestamos) {
                    // Buscar préstamos que contengan el correo del lector
            ...
            req.getRequestDispatcher("/historialLector.jsp").forward(req, resp);
